...
export class MeasurementEntity implements Entity {
    ...
    private drawArrowHead = (
        ...
        const baseOfArrow = endPoint
            .clone()
            .translate(
                vectorFromEndToStartUnit.multiply(
                    ARROW_HEAD_LENGTH * screenScale,
                ),
            );
        ...
        const leftCornerOfArrow = baseOfArrow
            .clone()
            .translate(
                perpendicularVector1.multiply(ARROW_HEAD_WIDTH * screenScale),
            );
        const rightCornerOfArrow = baseOfArrow
            .clone()
            .translate(
                perpendicularVector2.multiply(ARROW_HEAD_WIDTH * screenScale),
            );
    ...
    public distanceTo(shape: Shape): [number, Segment] | null {
        ...
        const rightVerticalLineDistanceInfo =
            rightVerticalLine.distanceTo(shape);
    ...
    public getSvgString(): string | null {
        throw new Error(
            'getSvgString for MeasurementEntity not yet implemented',
        );
        // return (
        //   this.segment.svg({
